...
class VirtualPrinter:
    ...
    def set_z_height(self, height: float):
        """Simulates setting the Z height."""
        print(f"[Hardware] Setting Z height to {height} mm...")
    ...
    '''
    def get_print_score(self):
        """Simulates evaluating a print score."""
        print("[Hardware] Retrieving the print score...")
        return { "print_score": self.print_score }
    '''
